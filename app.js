...
if (fanLoginBtn) {
  fanLoginBtn.addEventListener("click", () => loginAs("fan"));
}

const creatorLoginBtn = document.getElementById("creatorLoginBtn");
if (creatorLoginBtn) {
  creatorLoginBtn.addEventListener("click", () => loginAs("creator"));
}

const spotifyImportBtn = document.getElementById("spotifyImportBtn");
if (spotifyImportBtn) {
  spotifyImportBtn.addEventListener("click", connectSpotifyAudience);
}

const saveFanBtn = document.getElementById("saveFanBtn");
if (saveFanBtn) {
  saveFanBtn.addEventListener("click", saveFanProfile);
}
